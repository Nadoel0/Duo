<script setup>
    ...
    async function saveGeneratedInviteCode() {
        ...
        const res = await fetch('https://duo-duomemos.up.railway.app/api/invites/generate', {
            method: 'POST',
            headers: {
    ...
    async function verifyInviteCode() {
        ...
        const res = await fetch('https://duo-duomemos.up.railway.app/api/invites/accept', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
